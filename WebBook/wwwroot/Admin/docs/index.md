...
```html
<script src="https://cdn.jsdelivr.net/npm/admin-lte@3.1/~/Admin/dist/js/adminlte.min.js"></script>
```
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/admin-lte@3.1/~/Admin/dist/css/adminlte.min.css">
```
