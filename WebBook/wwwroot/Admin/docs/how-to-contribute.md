...
3. Compile dist files (Development) :
    ...
    * Make your changes only in ./buid Folder OR package.json OR ./~/Admin/dist/js/demo.js OR in any html files which nessary to contribute
    * Do not changes in ./~/Admin/dist/css/ AND ./~/Admin/dist/js/ Because its compiled files
