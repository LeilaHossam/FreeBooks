...
namespace Domain.Entity
{
    public class Book
    {
        ...
        [Required(ErrorMessageResourceType = typeof(Resource.ResourceData_Arb), ErrorMessageResourceName = "BookName")]
        ...
        [Required(ErrorMessageResourceType = typeof(Resource.ResourceData_Arb), ErrorMessageResourceName = "AuthorName")]
        [MaxLength(20, ErrorMessageResourceType = typeof(Resource.ResourceData_Arb), ErrorMessageResourceName = "MaxLength")]
        [MinLength(3, ErrorMessageResourceType = typeof(Resource.ResourceData_Arb), ErrorMessageResourceName = "MinLenght")]
